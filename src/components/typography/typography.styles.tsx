...
export const TypographyTextStyling2 = styled.div`
  ${css`
    ${TypographyTextStyling}
  `};
...
export const TypographyTextStyling3 = styled.div`
  ${css`
    ${TypographyTextStyling}
  `};
...
export const TypographyTextStyling4 = styled.div`
  ${css`
    ${TypographyTextStyling}
  `};
